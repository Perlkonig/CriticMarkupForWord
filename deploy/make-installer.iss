...
#define APP_GUID "{{A80AC434-73BB-4EE3-BFE7-A1189D5993D9}"
#define ADDIN_NAME "CriticMarkupForWord"
...
#define DESCRIPTION "Two-way conversion between CriticMarkup and tracked changes."
#define HOMEPAGE "https://github.com/Perlkonig/CriticMarkupForWord"
#define HOMEPAGE_SUPPORT "https://github.com/Perlkonig/CriticMarkupForWord/issues"
#define HOMEPAGE_UPDATES "https://github.com/Perlkonig/CriticMarkupForWord/releases"

; SOURCEDIR is the directory that contains the files that
; need to be installed; e.g. 'MyProject\bin\Release\'.
; Include a trailing slash!
#define SOURCEDIR "..\CriticMarkup\bin\Release\"
...
#define VSTOFILE "CriticMarkup.vsto"
...
; The SETUPFILESDIR *must* end with a backslash, unless it is empty.
